...
export const AuthModal: React.FC<AuthModalProps> = ({ onClose, onLoginSuccess }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-900/70 border border-purple-500/30 rounded-3xl p-8 max-w-sm w-full relative shadow-2xl shadow-purple-500/20">
                ...
                <div className="text-center">
                    <h2 className="font-orbitron text-2xl mb-2 text-white">Welcome to Nexus Coder</h2>
                    <p className="text-gray-400 mb-6">Sign in to launch your AI agent.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button 
                        type="submit"
                        className="w-full mt-6 text-base font-orbitron font-bold py-3 px-6 rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-500 hover:to-cyan-400 active:scale-95 transition-all duration-300"
                    >
